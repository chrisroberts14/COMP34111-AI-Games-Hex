...
Template Templates::row_2 = Template(2, std::make_shared<OpponentTile>(nullptr, nullptr, nullptr, nullptr, std::make_shared<EmptyTile>(), std::make_shared<EmptyTile>()));

std::vector<Template> Templates::row_3 = {
    Template(3, std::make_shared<OpponentTile>(
        nullptr, nullptr, nullptr, nullptr,
        std::make_shared<EmptyTile>(nullptr, nullptr, nullptr, nullptr, std::make_shared<EmptyTile>(), std::make_shared<EmptyTile>()),
        std::make_shared<EmptyTile>(nullptr, nullptr, nullptr, nullptr, std::make_shared<EmptyTile>())
    )),
    Template(3, std::make_shared<OpponentTile>(
        nullptr, nullptr, nullptr, nullptr,
        std::make_shared<EmptyTile>(nullptr, nullptr, nullptr, nullptr, std::make_shared<EmptyTile>(), std::make_shared<EmptyTile>()),
        nullptr, std::make_shared<EmptyTile>(nullptr, nullptr, nullptr, nullptr, std::make_shared<EmptyTile>(), std::make_shared<EmptyTile>())
    ))
};